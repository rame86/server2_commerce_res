            ...
            try {
                ...
                if (reservation && reservation.status !== 'FAILED') {
                    ...
                    await prisma.$transaction(async (tx) => {
                        ...
                        // 해당 공연의 재고(available_seats)를 취소 수량만큼 다시 증가(+)
                ...
                // 내부 로직 처리 중 에러 발생 시 로그를 남기고 메시지는 버림 (무한 루프 방지)
